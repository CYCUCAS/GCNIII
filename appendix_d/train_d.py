...
if __name__ == "__main__":
    ...
    model = GCN(in_size, 64, out_size, 2).to(device) # n_layers ∈ [2,3,4,5,8,16,32,64]
    # model = GCN_v(in_size, 64, out_size, 2).to(device) # n_layers ∈ [2,3,4,5,8,16,32,64]
